...
class Category(models.Model):
    ...
    color = models.CharField(max_length=7, default='#007bff', help_text=_('Hex color code'), verbose_name='کد رنگ')
    icon = models.CharField(max_length=50, blank=True, null=True, help_text=_('Font Awesome icon class'), verbose_name='کلاس آیکون')
