...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'pedendencies/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DATABASE_NAME', default=BASE_DIR / 'pedendencies/db.sqlite3'),
...
# Enable bi-directional (RTL) text support
LANGUAGE_BIDI = True
...
STATICFILES_DIRS = [
    BASE_DIR / 'pedendencies/static',
]

MEDIA_URL = '/media/'
MEDIA_ROOT = BASE_DIR / 'pedendencies/media'
...
# CSRF configuration compatible with frontend SPA
